...
def scan_and_insert(root_dir, dry_run=False, report=False):
    ...
    logging.info(f"Starting license insertion in: {os.path.abspath(root_dir)}")
    if dry_run:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Insert Apache 2.0 license headers into source files."
    )
    parser.add_argument(
        "root",
        nargs="?",
